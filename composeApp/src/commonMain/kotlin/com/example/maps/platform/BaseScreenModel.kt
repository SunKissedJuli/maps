...
internal abstract class BaseScreenModel<State : Any, SideEffect : Any>(initState: State) : ScreenModel,
    ...
    protected fun <T> launchOperation(
        ...
        return defaultModelScope.launch(handler) {
            loading.invoke(true)
